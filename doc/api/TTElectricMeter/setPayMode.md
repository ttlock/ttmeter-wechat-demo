...
## 方法
```
    function setPayMode(option: TTElectricMeter.SetPayMode): Promise<TTMeterError>;
```
...
### 参数说明  
##### option参数说明 TTElectricMeter.SetPayMode 
 |PARAMS        |TYPE       |REQUIRED      |DESCRIPTION|
 |--------------|-----------|--------------|-----------|
 |payMode       |number     |Y             |电表付费模式：0 -计能, 1 -预付费|
 |price         |number     |Y             |电费单价，单位：元/kwh|
 |(自定义属性)   |any        |N             |自定义扩展属性|
