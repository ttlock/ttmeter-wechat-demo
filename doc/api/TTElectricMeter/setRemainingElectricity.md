# 通通水电表接口说明-设置智能电表剩余电量  

## 方法
```
    function setRemainingElectricity(option: TTElectricMeter.SetRemainingElectricity): Promise<TTMeterError>;
```
...
### 参数说明 
##### option参数说明 TTElectricMeter.SetRemainingElectricity 
 |PARAMS        |TYPE       |REQUIRED      |DESCRIPTION|
 |--------------|-----------|--------------|-----------|
 |remainderKwh  |number     |Y             |剩余电量|
 |(自定义属性)   |any        |N             |自定义扩展属性|
