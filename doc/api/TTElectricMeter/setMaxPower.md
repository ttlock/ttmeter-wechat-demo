...
## 方法
```
    function setMaxPower(option: TTElectricMeter.SetMaxPower): Promise<TTMeterError>;
```
...
### 参数说明  
##### option参数说明 TTElectricMeter.SetMaxPower 
 |PARAMS            |TYPE       |REQUIRED      |DESCRIPTION|
 |------------------|-----------|--------------|-----------|
 |maxPower          |number     |Y             |最大功率阈值，取值范围：1-255, 整数|
 |(自定义属性)       |any        |N             |自定义扩展属性|
