...
## 方法
```
    function clearRemainingElectricity(option?: TTElectricMeter.ClearRemainingElectricity): Promise<TTMeterError>;
```
...
### 参数说明 
##### option参数说明 TTElectricMeter.ClearRemainingElectricity 
